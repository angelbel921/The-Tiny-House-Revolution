...
try {
	...
	dv_handler81.prototype = dv_baseHandlerIns;
dv_handler81.prototype.constructor = dv_handler81;

    var dv_handlersDefs = [{handler: new dv_handler81(), minRate: 0, maxRate: 90}];
